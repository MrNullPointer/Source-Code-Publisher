...
#ifdef TEST_DIREXPLORERP  // only compile the following when defined

#include "DirExplorerp.h"
...
{
  Title("Demonstrate DirExplorer-Provider, " + DirExplorerP::version());
